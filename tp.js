/* 
Realizar una función que reciba dos callbacks. El primer callback devuelve el array de objetos que se deben unir luego 
del tiempo en segundos que indica el retorno del segundo callback. La función devolverá una promesa. 
Se espera que dicha promesa, devuelva el resultado luego de la cantidad de segundos indicada. 
    ...
    return new Promise((resolve, reject) => {
        ...
        if (typeof tiempo() == "number" && tiempo() > 0) {
            if (Array.isArray(arr)) {
                setTimeout(() => resolve(Object.assign(...arr)), tiempo() * 1000);
            } else {
